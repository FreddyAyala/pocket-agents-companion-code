#!/bin/bash
# Setup and test script for Chapter 5 pruning and sparsity example

echo "🔧 Setting up Chapter 5: Pruning, Sparsity, and Distillation Demo"
echo "================================================================"
